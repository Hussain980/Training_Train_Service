...
public class TrainControllerTest {
	...
	public void testGetAllTrains() {
		...
		when(trainService.getAllTrains("Delhi","Kolkata",LocalDate.of(2021, 7, 12))).thenReturn(trainlist);
		 List<Train> trains =trainController.getAllTrains(trainDto);
	...
	public void testGetTrainDetails() {
		when(trainService.getTrainDetails(19222L)).thenReturn(train2);
		 Train train2db = trainController.getTrainDetails(19222L);
	...
	public void testGetTrainDetails1() {
		when(trainService.getTrainDetails(19222L)).thenReturn(null);
		Train train = trainController.getTrainDetails(19222L);
		assertEquals(null, train);
	}
